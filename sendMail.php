...
<body>
  ...
  This form will attempt to send a test email. Please enter where this test should be sent to<br>
  <p>
  <form action="sendMail.php" method="post" name="sendmail">
    Enter an email address: <input type="text" name="to"><br>
    <input type="submit" value="Send" name="submit"><input type="reset" value="Reset" name="reset"><br>
    <p>
